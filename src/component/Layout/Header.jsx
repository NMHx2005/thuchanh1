const Header = () => {
    return (
        <>
            <header className="w-full  flex justify-between items-center px-[100px] py-[30px]  shadow bg-white">
                {/* Logo */}
                ...
                <nav className="flex space-x-10">
                    ...
                    <a href="#" className="text-gray-700 hover:text-green-600">Service</a>
                    <a href="#" className="text-gray-700 hover:text-green-600">Feature</a>
                    <a href="#" className="text-gray-700 hover:text-green-600">Product</a>
                    <a href="#" className="text-gray-700 hover:text-green-600">Testimonial</a>
            ...
            {/* <div className="w-[full px-[144px] bg-[#F5F7FA]" >
                <div className="flex">
                    <div className="mt-[160px] mr-[105px]">
                        <h1 className="font-bold text-[64px] color-[#171717]">Lessons and insights</h1>
                        <p className="font-bold text-[60px] color-[#4CAF4F]">from 8 years</p>
                        <p className="text-size[16px]">Where to grow your business as a photographer: site or social media?</p>
                        <button>Registers</button>
                    </div>
                    <div className="mt-[96px] mb-[96px]"><img src="./Logo2.png" alt="" /></div>
                </div>
            </div>
            ...
            <div className="px-[144px] py-[42px] mt-[16px]">
                ...
                <div className="flex  mt-[20px] w-[100%] justify-between mb-[90px] ">
                    <div class="relative max-w-sm  rounded-[10px]  ">
                        <img class="w-368 h-[286px] rounded-2xl bg-cover" src="./F8.png" alt="" />
                        <div class="absolute p-[20px] left-9 top-52 w-[80%] bg-white shadow-2xl rounded-lg  text-center">
                            <h3 class="text-lg font-semibold text-gray-700">
                                Revamping the Membership Model with Triathlon Australia
                            </h3>
                            <a href="#" class="mt-3 inline-block text-green-600 font-[600]">
                                Readmore →
                            </a>
                        </div>
                    </div><div class="relative max-w-sm  rounded-[10px] ">
                        <img class="w-368 h-[286px] rounded-2xl bg-cover" src="./F8.png" alt="" />
                        <div class="absolute p-[20px] left-9 top-52 w-[80%] bg-white shadow-2xl rounded-lg  text-center">
                            <h3 class="text-lg font-semibold text-gray-700">
                                Revamping the Membership Model with Triathlon Australia
